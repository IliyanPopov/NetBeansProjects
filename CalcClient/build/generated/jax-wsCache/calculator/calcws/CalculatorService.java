 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://calcws/", wsdlLocation = "http://localhost:666/calculator?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:666/calculator?wsdl");
