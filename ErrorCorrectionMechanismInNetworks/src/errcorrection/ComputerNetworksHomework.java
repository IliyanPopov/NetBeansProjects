package computernetworkshomework;
...
public class ComputerNetworksHomework {
    ...
    public static void main(String args[]) throws IOException {
        ...
        int[] rem;
        int[] crc;
        int data_bits, divisor_bits, totLength;
        int test = 0;
...
//        divisor=new int[divisor_bits];
         ...
         */
        //appedning the zeros
        totLength = split.length + split1.length - 1;
        ...
        System.out.println();
        System.out.print("Message to be transmitted: ");
        ...
        System.out.print("Polynomial bits are : ");
...
//        }
        ...
        while (test >= crc.length + 1 || test < 0) {
            System.out.println("Wrong bit position");
            System.out.print("Enter a position of a bit to be inverted: ");
            test = Integer.parseInt(br.readLine());
        }

        if (test == 0) {
            System.out.print("Message without changes!!");
            System.out.println("");
            for (int i = 0; i < crc.length; i++) {
                System.out.print(crc[i] + " ");
            }
